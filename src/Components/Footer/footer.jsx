            ...
            <div className="bg-footer">
                <div className="hero-container position-relative z-2">
                        ...
                        <div className="row row-cols-lg-4 row-cols-md-2 row-cols-1 grid-spacer-5">
                            <div className="col col-lg-4">
                                <div className="footer-logo-container">
                                    ...
                                    <img src="/assets/images/incorelab-logo.png" alt="Logo" className="site-logo img-fluid" />
                                    </div>
                            ...
                            <div className="col col-lg-3">
                                <div className="footer-contact-container">
                                    ...
                                    <ul className="contact-list">
                                        <li>hello@incorelabagency.com</li>
                                        <li>+1 234 567 890</li>
                    ...
                    <div className="copyright-container">
                        <span className="copyright">© 2025 incorelab. Fox Creation All Rights Reserved.</span>
